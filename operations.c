...
void    pa(t_stack *stack_a, t_stack *stack_b)
{
	...
	temp_node_a = stack_b->first_node; //first node
	...
	{
		stack_a->first_node = temp_node_a; //first node in stack b is now first node in stack a
		stack_a->last_node = temp_node_a; //last node in stack b is now first node in stack a
	...
	{
		temp_node_b = stack_a->first_node; //first node in stack b
		stack_a->first_node = temp_node_a; //first node in stack b is now first node in stack a
		stack_a->first_node->next = temp_node_b; //next of first node in stack b is now second node in stack b
		temp_node_b->previous = stack_a->first_node; //previous of second node in stack b is now first node in stack b
	}
